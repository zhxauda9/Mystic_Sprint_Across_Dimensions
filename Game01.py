...
pygame.display.set_caption("Mystic Sprint: Across Dimensions.")
icon = pygame.image.load("images/icon.png")
pygame.display.set_icon(icon)

bg_main = pygame.image.load("images/bg/bg_main2.jpg").convert()
bg1 = pygame.image.load("images/bg/bg06.jpg").convert()
bg2 = pygame.image.load("images/bg/bg05.jpg").convert()
bg_load = pygame.image.load("images/bg/bg_main3.jpg")
bg_end = pygame.image.load("images/bg/bg_main4.jpg").convert()
font_path = "images/VT323-Regular.ttf"
font = pygame.font.Font(font_path, 32)

walk_left = [
    pygame.image.load(
        "images/player/left (1).png").convert_alpha(),
    pygame.image.load(
        "images/player/left (2).png").convert_alpha(),
    pygame.image.load(
        "images/player/left (3).png").convert_alpha(),
    pygame.image.load(
        "images/player/left (4).png").convert_alpha(),
]
walk_right = [
    pygame.image.load(
        "images/player/right (1).png").convert_alpha(),
    pygame.image.load(
        "images/player/right (2).png").convert_alpha(),
    pygame.image.load(
        "images/player/right (3).png").convert_alpha(),
    pygame.image.load(
        "images/player/right (4).png").convert_alpha(),
]
attack25 = pygame.image.load(
    "images/items/attack25.png").convert_alpha()
health25 = pygame.image.load(
    "images/items/health25.png").convert_alpha()
health100 = pygame.image.load(
    "images/items/health100.png").convert_alpha()
book = pygame.image.load(
    "images/items/book.png").convert_alpha()
ring = pygame.image.load(
    "images/items/ring.png").convert_alpha()
book_count = 0
ring_count = 0
attack_f = 0.003
health25_f = 0.003
...
attack = [
    pygame.image.load("images/effect/1e.png").convert_alpha(),
    pygame.image.load("images/effect/2e.png").convert_alpha(),
    pygame.image.load("images/effect/3e.png").convert_alpha(),
    pygame.image.load("images/effect/4e.png").convert_alpha(),
    pygame.image.load("images/effect/5e.png").convert_alpha(),
    pygame.image.load("images/effect/6e.png").convert_alpha(),
    pygame.image.load("images/effect/7e.png").convert_alpha(),
    pygame.image.load("images/effect/8e.png").convert_alpha(),
]
attacks = []
at_anim = 0
attack_left = 5
attack_bar = [
    pygame.image.load(
        "images/progress bar/a1.gif").convert_alpha(),
    pygame.image.load(
        "images/progress bar/a2.gif").convert_alpha(),
    pygame.image.load(
        "images/progress bar/a3.gif").convert_alpha(),
    pygame.image.load(
        "images/progress bar/a4.gif").convert_alpha(),
    pygame.image.load(
        "images/progress bar/a5.gif").convert_alpha(),
]  # violet
health_bar = [
    pygame.image.load(
        "images/progress bar/h1.gif").convert_alpha(),
    pygame.image.load(
        "images/progress bar/h2.gif").convert_alpha(),
    pygame.image.load(
        "images/progress bar/h3.gif").convert_alpha(),
    pygame.image.load(
        "images/progress bar/h4.gif").convert_alpha(),
    pygame.image.load(
        "images/progress bar/h5.gif").convert_alpha(),
]  # red
h_c = 5

gob_walk_left = [
    pygame.image.load(
        "images/enemies/magician/left/left1.png").convert_alpha(),
    pygame.image.load(
        "images/enemies/magician/left/left2.png").convert_alpha(),
    pygame.image.load(
        "images/enemies/magician/left/left3.png").convert_alpha(),
]
gob_walk_right = [
    pygame.image.load(
        "images/enemies/magician/right/right1.png").convert_alpha(),
    pygame.image.load(
        "images/enemies/magician/right/right2.png").convert_alpha(),
    pygame.image.load(
        "images/enemies/magician/right/right3.png").convert_alpha(),
]
gob_list = []
gob_anim_count = 0
gob_speed = 50
...
gob_walk_left2 = [
    pygame.image.load(
        "images/enemies/goblin/left/01.png").convert_alpha(),
    pygame.image.load(
        "images/enemies/goblin/left/02.png").convert_alpha(),
    pygame.image.load(
        "images/enemies/goblin/left/03.png").convert_alpha(),
    pygame.image.load(
        "images/enemies/goblin/left/04.png").convert_alpha(),
]
gob_walk_right2 = [
    pygame.image.load(
        "images/enemies/goblin/right/01.png").convert_alpha(),
    pygame.image.load(
        "images/enemies/goblin/right/02.png").convert_alpha(),
    pygame.image.load(
        "images/enemies/goblin/right/03.png").convert_alpha(),
    pygame.image.load(
        "images/enemies/goblin/right/04.png").convert_alpha(),
]
gob_list2 = []
gob_anim_count2 = 0
gob_speed2 = 50
...
vanish = [
    pygame.image.load("images/effect/v1.png").convert_alpha(),
    pygame.image.load("images/effect/v2.png").convert_alpha(),
    pygame.image.load("images/effect/v3.png").convert_alpha(),
]
v_anim = 0
...
down_text2 = down_font.render("Directed by Zhalgassova Aida(SE - 2307)", True, (210, 145, 255))
down_rect2 = down_text2.get_rect(center=(675 // 2, 340))

shadow_offset = 4
shadow_color = (66, 0, 109)
myfont = pygame.font.Font("images/VT323-Regular.ttf", 70)
...
end_font = pygame.font.Font("images/VT323-Regular.ttf", 70)
...
teleport_images = [
    pygame.transform.scale(pygame.image.load(
        "images/teleport/01.png").convert_alpha(), (40, 80)),
    pygame.transform.scale(pygame.image.load(
        "images/teleport/02.png").convert_alpha(), (40, 80)),
    pygame.transform.scale(pygame.image.load(
        "images/teleport/03.png").convert_alpha(), (40, 80)),
    pygame.transform.scale(pygame.image.load(
        "images/teleport/04.png").convert_alpha(), (40, 80)),
]
t_anim = 0
...
def draw_loading_screen(progress):
    ...
    load_font = pygame.font.Font("images/VT323-Regular.ttf",
                                 50)
    ...
    for event in pygame.event.get():
        ...
        #     teleport_ready=True
            ...
            attack_music = pygame.mixer.Sound(
                "images/sounds/mixkit-fantasy-game-sweep-notification-255.wav")
            attack_music.play()
                ...
                if keys[pygame.K_UP] or keys[pygame.K_SPACE]:
                    if jump_music is None:
                        jump_music = pygame.mixer.Sound(
                            "images/sounds/cartoon-jump-6462.mp3")
                        jump_music.play()
                        jump_music = None
                    is_jump = True
            else:
